...
const HeroSection = () => {
    ...
    return (
        <>
            <section className=' lg:bg-hero_section_bg md:bg-no-repeat md:bg-cover relative 2xl:h-[810px]'>
                ...
                <div className=' container  relative z-20'>
                    <div className=' flex flex-col pt-[50px] pb-0 md:pt-[80px] lg:pt-[160px] md:pb-[80px]  xl:pb-[190px]'>
                        <div className=' flex flex-col '>
                            <p className=' ff-hel font-[400] text-[18px] leading-[24px] text-orange text-center lg:text-start'>Marc Joachim Hubrich</p>
                            <h2 className=' uppercase text-black ff-hel font-[400] text-[32px] sm:text-[45px] md:text-[60px] leading-[45px] md:leading-[77px]  text-center lg:text-start pt-1 md:pt-0'>Now I let you <span className=' lg:block'>go!</span></h2>
                            <p className=' lg:max-w-[517px] text-black md:opacity-70 font-Poppins font-[400] text-[14px] md:text-[16px] leading-[22px] md:leading-[25px] text-center lg:text-start pt-[16px] md:pt-2'>For women who do not want to be completely dragged down by a SEPARATION.</p>
                            <p className=' lg:max-w-[517px] text-black md:opacity-70 font-Poppins font-[400] text-[14px] md:text-[16px] leading-[22px] md:leading-[25px] text-center lg:text-start'>How to let go of your EX so you can leave him behind
                                without having to run to a therapist right away.</p>
                            <div className=' flex justify-center lg:justify-start items-center gap-[17px] pt-8'>
                                <CommonBtn />
                                <a href="tel:+6494461709"><img className=' cursor-pointer' src={phon} alt="phon-icon" /></a>
                            </div>
                        </div>
                        <div className=' xl:absolute pt-[40px]  justify-center lg:justify-start right-[134px] bottom-[45px]  flex gap-[45px]'>
                ...
                <img className=' max-md:hidden pointer-events-none max-w-[450px] d_none z-10 w-full left-[-40%] sm:left-[-20%] md:left-[-10%] top-[0%] xl:left-[0px] absolute' src={elipse1} alt="elipse" />
            </section>
        </>
    )
}
