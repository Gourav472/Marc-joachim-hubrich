        ...
        <>
            <section className=' pt-[48px] md:pt-[80px] lg:pt-[151px] pb-[34px] relative'>
                <div className=' container relative z-20'>
                    <div className=' flex flex-col items-center xl: ms-7'>
                        <div className=' flex flex-col md:flex-row md:gap-[35px] lg:gap-[61px]'>
                            <div className=' flex gap-[15px] justify-center md:justify-start  md:gap-0 md:flex-col'>
                            ...
                            <div className=' flex justify-center items-center gap-[11px] pt-[20px] md:pt-0'>
                        ...
                        <p className=' pt-[30px] md:pt-[58px] capitalize ff-hel font-[400] text-[16px] md:text-[20px] leading-[22px] md:leading-[28px] text-black text-center'>How would you know when you are busy with completely different things at the moment:</p>
                    </div>
                    <img className=' pointer-events-none max-w-[160px] w-full d_block z-10 absolute hidden bottom-[200px] left-[-20%] ' src={elipse2} alt="elipse2" />
                    <img className=' pointer-events-none absolute d_block hidden right-[-35%]  bottom-[-10%] z-10 max-w-[210px]' src={elipse3} alt="elipse" />

                </div>
                <img className=' pointer-events-none max-w-[160px]  w-full d_none z-10 absolute rotate-90 xl:rotate-0 left-[100px] bottom-[150px] max-md:hidden  2xl:bottom-[230px] 2xl:left-[142px]' src={elipse2} alt="elipse2" />
