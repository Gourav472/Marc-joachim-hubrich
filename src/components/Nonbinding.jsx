            ...
            <section id='testimonials'>
                <div className=' pt-[30px] md:pt-[71px] bg-[#F2F8FF] pb-[30px] md:pb-[59x] '>
                    <div className=' container'>
                        <div className='  flex flex-wrap lg:flex-nowrap justify-center lg:justify-between'>
                            ...
                            <div className=' flex items-center md:ps-4 pt-4 lg:pt-0 gap-[12px]'>
                ...
                <div className=' bg-[url(./assets/webp/Binding-bg.webp)] bg-no-repeat bg-cover pt-[48px] pb-[48px] md:pt-[80px] md:pb-[80px] lg:pt-[111px] lg:pb-[186px]'>
                    <div className=' max-md:hidden container'>
                        <div className='  flex flex-row justify-center flex-wrap mx-[-12px]'>
                        ...
                        <div className=' flex flex-wrap flex-row mx-[-12px] pt-6 lg:pt-[34px] justify-center'>
